""" This is a copy of the original balckjack.py file with the game_menu() and user input commented out
...
Player1 = User('Player1')  # instantiate class instance for user
print('Welcome %s ' % Player1.name)
Dealer = User('Dealer')  # instantiate class instance for dealer
